...
function Navbar({ products, carts, setToken }) {
  ...
  useEffect(() => {
    ...
    } else if (tab === "redixcounter") {
     redixcounterRef.current.click();
  ...
  return (
    <div className="navbar-container">
      ...
      <Link to={"/redixcounter"}>
        <button
          className={
            "btn" +
            (tab === "redixcounter" ? " btn-primary" : " btn-outline-primary")
          }
          onClick={() => setTab("redixcounter")}
          ref={redixcounterRef}
        >
          Redix-Counter
        </button>
