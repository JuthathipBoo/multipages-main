  ...
  return (
    <div className="temper-container">
      ...
      <div className="temper-variables">
          <Value type="real" name="Celsius"  value={celsius}  setValue={CelsiusChange}/> 
          <Value type="real" name="Fahrenheit"  value={fahrenheit}  setValue={FahrenhitChange}/>
          <Value type="real" name="Kelvin"  value={kelvin} setValue={KelvinChange}/>
      </div>
